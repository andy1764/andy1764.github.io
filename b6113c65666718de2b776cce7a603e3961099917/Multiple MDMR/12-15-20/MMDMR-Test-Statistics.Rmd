...
## $m = 2$ results
```{r, fig.width=10, fig.height=6, fig.align="center", out.width="80%"}
(plots$large$`2_1` + labs(title = "Low Correlation, First PC") + 
   plots$large_high_corr$`2_1` + labs(title = "High Correlation, First PC")) /
  (plots$large$`2_all` + labs(title = "Low Correlation, All PCs") +
     plots$large_high_corr$`2_all` + labs(title = "High Correlation, All PCs")) + 
...
## $m = 3$ results
```{r, fig.width=10, fig.height=6, fig.align="center", out.width="80%"}
(plots$large$`3_1` + labs(title = "Low Correlation, First PC") + 
   plots$large_high_corr$`3_1` + labs(title = "High Correlation, First PC")) /
  (plots$large$`3_all` + labs(title = "Low Correlation, All PCs") +
     plots$large_high_corr$`3_all` + labs(title = "High Correlation, All PCs")) + 
  plot_layout(guides = "collect") & theme(legend.position = 'bottom')
```
---
...
## $m = 5$ results
```{r, fig.width=10, fig.height=6, fig.align="center", out.width="80%"}
(plots$large$`5_1` + labs(title = "Low Correlation, First PC") + 
   plots$large_high_corr$`5_1` + labs(title = "High Correlation, First PC")) /
  (plots$large$`5_all` + labs(title = "Low Correlation, All PCs") +
     plots$large_high_corr$`5_all` + labs(title = "High Correlation, All PCs")) + 
  plot_layout(guides = "collect") & theme(legend.position = 'bottom')
```
---
...
## $m = 10$ results
```{r, fig.width=10, fig.height=6, fig.align="center", out.width="80%"}
(plots$large$`10_1` + labs(title = "Low Correlation, First PC") + 
   plots$large_high_corr$`10_1` + labs(title = "High Correlation, First PC")) /
  (plots$large$`10_all` + labs(title = "Low Correlation, All PCs") +
     plots$large_high_corr$`10_all` + labs(title = "High Correlation, All PCs")) + 
  plot_layout(guides = "collect") & theme(legend.position = 'bottom')
```