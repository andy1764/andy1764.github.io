...
load("results/coupling_25_sample.Rdata")
load("results/explore_dists.Rdata")
load("results/sim_plots.Rdata")
plots_high <- plots$`25_high_corr_PCs`
plots_low <- plots$`25_low_corr_PCs`
...
limnod <- max(abs(res[[3]]$E - diag(diag(res[[3]]$E))))
...
## Exploring MDS axes
```{r, message = FALSE, fig.align="center", out.width = "80%", fig.width = 10, fig.height = 3}
plot_mat(res[[3]]$E[1:25, 26:50], lims = c(-limnod, limnod)) + labs(title = "n-backFC and SC") + 
  plot_mat(res[[3]]$E[1:25, 51:75], lims = c(-limnod, limnod)) + labs(title = "n-backFC and rsFC") + 
  plot_mat(res[[3]]$E[26:50, 51:75], lims = c(-limnod, limnod)) + labs(title = "rsFC and SC") +
...
gghist(res[[3]]$E[1:25, 26:50]) + labs(title = "n-backFC and SC") + 
  gghist(res[[3]]$E[1:25, 51:75]) + labs(title = "n-backFC and rsFC") + 
  gghist(res[[3]]$E[26:50, 51:75]) + labs(title = "rsFC and SC") +
  plot_layout(guides = "collect") & theme(legend.position = 'bottom')
```